  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="max-w-screen-2xl mx-auto p-6">  
        ...
        <div className="bg-white rounded-[24px] shadow-card p-8 mb-8 border border-[#E5E7EB]">
          ...
          <div className="mt-6 bg-[#EF6B00] rounded-[24px] p-8 text-white shadow-card">
            ...
            <div className="grid grid-cols-3 gap-6 mt-8 pt-6 border-t border-white/30 text-center">
              {[
                { label: "高端设计结算", value: MOCK_SETTLEMENT_DATA.pricing.design },
                { label: "严选精品结算", value: MOCK_SETTLEMENT_DATA.pricing.product },
                { label: "匠心施工结算", value: MOCK_SETTLEMENT_DATA.pricing.construction },
              ].map((item, i) => (
        ...
        {/* E - Design */}
        <SettlementTable title="高端设计结算明细" items={MOCK_SETTLEMENT_DATA.designItems} />

        {/* P - Product */}
        <SettlementTable title="严选精品结算明细" items={MOCK_SETTLEMENT_DATA.productItems} />

        {/* C - Construction */}
        <SettlementTable title="匠心施工结算明细" items={MOCK_SETTLEMENT_DATA.constructionItems} />
